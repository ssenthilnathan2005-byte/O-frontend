    ...
    <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="font-semibold text-amber-800">Your patient records export is ready</p>
          <p className="text-sm text-amber-700 mt-0.5">An export of your past patient records has been generated by the admin. Download and save it for your records — this is for your reference only and your data remains safe in the system.</p>
